...
int PersistentBloomFilter::insert(byte *element)
{
...
bool PersistentBloomFilter::lookup(byte *element)
{
    for (size_t i=0; i<this->hash_funcs; i++) {
...
size_t PersistentBloomFilter::hash(byte *key, size_t hash_func)
{
